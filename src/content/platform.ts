...
export const platform = {
  "pt-BR": {
    ...
    hero: {
      ...
      title: "Do clique no anúncio à cadeira da clínica.",
      titleEm: "Com a verdade voltando.",
      lead: "Uma plataforma feita para clínicas de saúde, que acompanha cada paciente do primeiro clique ao atendimento e devolve para os anúncios o que aconteceu de verdade.",
    ...
    features: [
      {
        ...
        body: "Todas as conversas do WhatsApp da clínica num lugar só, com quem está esperando e há quanto tempo. A janela de 24 horas do WhatsApp aparece antes que ela feche.",
    ...
    more: {
      ...
      items: [
        ...
        ["Ditado por voz", "O profissional fala, a plataforma transcreve o rascunho da evolução."],
        ...
        ["Despesas", "O extrato importado e categorizado, para o DRE fechar."],
  ...
  en: {
    ...
    hero: {
      ...
      title: "From the ad click to the clinic chair.",
      titleEm: "With the truth coming back.",
      lead: "A platform made for health clinics that follows every patient from the first click to the visit, and tells the ads what really happened.",
    ...
    features: [
      {
        ...
        body: "All the clinic's WhatsApp conversations in one place, with who's waiting and for how long. WhatsApp's 24-hour window shows before it closes.",
    ...
    more: {
      ...
      items: [
        ...
        ["Voice dictation", "The practitioner speaks, the platform transcribes the note's draft."],
        ...
        ["Expenses", "The bank statement imported and categorized, so the P&L closes."],
