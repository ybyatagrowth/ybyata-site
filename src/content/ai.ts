...
export const ai = {
  "pt-BR": {
    ...
    lead: "A Ybyatã lê cada conversa, percebe o que aconteceu e deixa pronto para a sua equipe confirmar. O trabalho repetitivo sai da frente; a decisão continua com quem conhece o paciente.",
    capabilities: [
      { title: "Lê cada conversa", body: "Entende quando alguém agendou, compareceu ou pagou, e propõe a mudança com o trecho da conversa e quão certa está." },
      ...
      { title: "Transcreve áudios", body: "Os áudios dos pacientes viram texto, e o ditado do profissional vira o rascunho da evolução." },
  ...
  en: {
    ...
    lead: "Ybyatã reads every conversation, notices what happened and leaves it ready for your team to confirm. The repetitive work gets out of the way; the decision stays with the people who know the patient.",
    capabilities: [
      { title: "Reads every conversation", body: "Understands when someone booked, came or paid, and proposes the change with the passage it relied on and how sure it is." },
      ...
      { title: "Transcribes audio", body: "Patients' voice notes become text, and the practitioner's dictation becomes the progress note's draft." },
