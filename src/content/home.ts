  ...
  "pt-BR": {
    ...
    strip: {
      ...
      items: [
        ...
        { title: "Pergunte à Ybyatã", body: "Um assistente que conhece a agenda, os pacientes e os números da clínica.", image: "/media/assistant.png" },
  ...
  en: {
    ...
    strip: {
      ...
      items: [
        ...
        { title: "Ask Ybyatã", body: "An assistant that knows the clinic's schedule, patients and numbers.", image: "/media/assistant.png" },
